  ...
  const skillCards: SkillCardProps[] = [
    {
      ...
      title: t('skillReactTitle'),
      description: t('skillReactDescription'),
      color: "bg-blue-500"
    },
    {
      icon: (
      ...
      title: t('skillDotNetTitle'),
      description: t('skillDotNetDescription'),
      color: "bg-purple-500"
    },
    {
      icon: (
      ...
      title: t('skillPythonTitle'),
      description: t('skillPythonDescription'),
      color: "bg-yellow-500"
    },
    {
      icon: (
      ...
      title: t('skillCppTitle'),
      description: t('skillCppDescription'),
      color: "bg-blue-500"
    },
    {
      icon: (
      ...
      title: t('skillGitTitle'),
      description: t('skillGitDescription'),
      color: "bg-orange-500"
    },
    {
      icon: (
      ...
      title: t('skillFirebaseTitle'),
      description: t('skillFirebaseDescription'),
      color: "bg-red-500"
    }
  ];
